...
#define Z_BACK_LIMIT 2500
#define Z_FORWARD_LIMIT 1500
#define X_LIMIT 500
#define Z_OUTER_BACK_LIMIT 3000
#define Z_OUTER_FORWARD_LIMIT 1000
#define X_OUTER_LIMIT 1000
...
public:
	...
	KinectController(bool useHandTracker,StatisticsManager* stats);
	~KinectController();
	void changeCandidateID(XnUserID ID);
	XnStatus initPrimeSensor(bool useHandTracker);
	Image* takeSnapshot();
	bool updateUserNode(XnUserID ID);
	bool addTime(Real deltaTime,bool transitionInProgress=false);
