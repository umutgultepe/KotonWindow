...
#ifndef PHOTO_SELECTION_STATE_HPP
#define PHOTO_SELECTION_STATE_HPP
...
class PhotoSelectionState : public AppState
{
public:
    PhotoSelectionState();
 
    DECLARE_APPSTATE_CLASS(PhotoSelectionState)
	...
	Hikari::FlashValue onShare(FlashControl* caller, const Hikari::Arguments& args);
